    ...
    def make_move(self, piece, x, y, keep_history=False):
        ...
        if keep_history:
            ...
            if isinstance(self.board[x][y], ChessPiece):
                ...
                if target_piece.color == 'white' and target_piece in self.whites:
                    self.whites.remove(target_piece) 
                elif target_piece.color == 'black' and target_piece in self.blacks:
                    self.blacks.remove(target_piece)
